...
Are the final results (i.e. average svore for each student) correlated with the results (i.e. scores) for the individual homeworks - the gradebook columns?
```{r}
...
```
Now we want the code to return the most predictive homework assignment with the highest correlation.
